...
using WebApplication6.Models.Manage;
 ...
 
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new IndexModel
            {
                ...
                Adress = user.Adress,
                City = user.City,
                CountryOrState = user.CountryOrState
        ...
        public async Task<IActionResult> Index(IndexModel model)
        {
           ...
           var firstName = user.FirstName;
            ...
            {
                var setFirstName = _userservice.SetFirstName(user.Id, model.FirstName);
            ...
            {
                var setLastName = _userservice.SetLastName(user.Id , model.LastName);
            ...
            if (model.Adress != Adress)
            {
                var setAdress = _userservice.SetAdress(user.Id, model.Adress);
            }
 
            var City = user.City;
            if (model.City != City)
            {
                var setAdress = _userservice.SetCity(user.Id, model.City);
            }
 
            var CountryOrState = user.CountryOrState;
            if (model.CountryOrState != CountryOrState)
            {
                var setAdress = _userservice.SetCountryOrState(user.Id, model.CountryOrState);
            }
